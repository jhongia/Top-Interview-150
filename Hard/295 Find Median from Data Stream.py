...
class MedianFinder:
    ...
    def findMedian(self) -> float:
        ...
        self.md.sort()
        if n % 2 != 0:
            return self.md[int(n//2)]
        return (self.md[int(n/2)-1] + self.md[int(n/2)]) / 2
...
print(medianFinder.addNum(6))
print(medianFinder.findMedian())
print(medianFinder.addNum(10))
print(medianFinder.findMedian())
...
# print(medianFinder.addNum(2))    # arr = [1, 2]
# print(medianFinder.findMedian()) # return 1.5 (i.e., (1 + 2) / 2)
# print(medianFinder.addNum(3))    # arr[1, 2, 3]
